...
export AUTH_SERVICE_UPSTREAM API_SERVICE_UPSTREAM AUDIT_SERVICE_UPSTREAM \
  NOTIFICATION_SERVICE_UPSTREAM FRONTEND_PUBLIC_ORIGIN FRONTEND_UPSTREAM
...
variables='$AUTH_SERVICE_UPSTREAM $API_SERVICE_UPSTREAM $AUDIT_SERVICE_UPSTREAM $NOTIFICATION_SERVICE_UPSTREAM $FRONTEND_PUBLIC_ORIGIN'
